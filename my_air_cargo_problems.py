...
class AirCargoProblem(Problem):
    ...
    def actions(self, state: str) -> list:
        ...
        possible_actions = [
            ...
            if set(action.precond_pos).issubset(pos_fluents)
               and set(action.precond_neg).issubset(neg_fluents)
        ]
    ...
    def result(self, state: str, action: Action):
        ...
        new_pos = [item for item in fs.pos if item not in action.effect_rem] + action.effect_add
