...
class PlanningGraph():
    ...
    def interference_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        :return: bool
        """
        pos_matches_1 = [e for e in node_a1.action.effect_add if e in node_a2.action.precond_neg]
        pos_matches_2 = [e for e in node_a2.action.effect_add if e in node_a1.action.precond_neg]
        neg_matches_1 = [e for e in node_a1.action.effect_rem if e in node_a2.action.precond_pos]
        neg_matches_2 = [e for e in node_a2.action.effect_rem if e in node_a1.action.precond_pos]
        return pos_matches_1 or pos_matches_2 or neg_matches_1 or neg_matches_2
